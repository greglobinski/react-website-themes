...
}), ';h1{line-height:1;text-align:center;font-size:2.2em;margin-bottom:0.5em;}img{max-width:100%;margin:20px 0;}a{align-items:center;background:#999;border-radius:3px;color:#fff;display:flex;font-size:1em;height:2.4em;line-height:1;text-decoration:none;text-transform:uppercase;padding:0 2em;margin:30px 0;animation:', breath, ' 6s ease infinite;}label:heroStyle;');
