...
export { default as MainMenuItem } from './components/MainMenuItem';
...
export { default as mainMenu } from './styles/mainMenu';
export { default as mainMenuItem } from './styles/mainMenuItem';
